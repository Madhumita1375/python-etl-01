...
try:
    ...
    insert_sql = f"""
        INSERT INTO j25madhumita_devdw.productlines (
            productLine,
            textDescription,
        ...
        LEFT JOIN j25madhumita_devdw.productlines p
    ...
    update_sql = f"""
        ...
        FROM updated u
        WHERE j25madhumita_devdw.productlines.productLine = u.productLine;
    """
